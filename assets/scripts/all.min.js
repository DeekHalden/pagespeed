...
$(document).ready(function() {
	$('#equipment__additional_slider').magnificPopup({type: 'image',
		delegate: 'a',
		type: 'image',
...
//       $('.services__row--card', this).each(function(){
...
//       $('.services__row--card',this).height(highestBox);
...
(function ($, window, i) {
  $.fn.responsiveSlides = function (options) {
    ...
    var settings = $.extend({
      ...
      "namespace": "main__slider--slides",   // String: change the default namespace used
...
$(function () {
      ...
      $(".additional-slider").responsiveSlides({
        auto: false,
        pager: false,
        nav: true,
        speed: 500,
